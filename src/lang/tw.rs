...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About RustDesk", "關於 HDesk"),
        ("About HDesk", "關於 HDesk"),
        ...
        ("Plugin", "外掛"),
        ("Reload", "重新載入"),
        ("No plugins available.", "目前沒有可用外掛。"),
        ("Reset keyboard shortcuts permission", "重設鍵盤快捷鍵權限"),
        ("clear-shortcuts-inhibitor-permission-tip", "重設已記住的鍵盤快捷鍵權限。"),
        ("confirm-clear-shortcuts-inhibitor-permission-tip", "確定要重設已儲存的鍵盤快捷鍵權限嗎？"),
        ...
        ("Check for software update", "檢查軟體更新"),
        ("You are already using the latest version.", "目前已是最新版本。"),
        ("Check and get the latest stable version of HDesk.", "檢查並取得 HDesk 的最新穩定版本。"),
        ("A newer version is available and can be downloaded and installed directly.", "已偵測到新版本，可直接下載並安裝。"),
        ("A newer version is available. Visit the website to download the update.", "已偵測到新版本，可前往官網取得更新。"),
        ("Desktop remote control client", "桌面端遠端控制客戶端"),
        ("Auto update", "自動更新"),
