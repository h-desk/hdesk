...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, HDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install HDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant HDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant HDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow HDesk to use the \"Accessibility\" service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next HDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant HDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant HDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running HDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verify HDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use HDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade HDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent HDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by HDesk"),
        ("Show RustDesk", "Show HDesk"),
        ("Keep RustDesk background service", "Keep HDesk background service"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if HDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep HDesk background service"),
        ...
        ("About RustDesk", "About HDesk"),
        ("About HDesk", "About HDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the HDesk client to version {} or newer on the remote side!"),
        ...
        ("clear-shortcuts-inhibitor-permission-tip", "Reset the remembered keyboard shortcuts permission."),
        ("confirm-clear-shortcuts-inhibitor-permission-tip", "Are you sure you want to reset the remembered keyboard shortcuts permission?"),
        ...
        ("Check and get the latest stable version of HDesk.", "Check and get the latest stable version of HDesk."),
        ("A newer version is available and can be downloaded and installed directly.", "A newer version is available and can be downloaded and installed directly."),
        ("A newer version is available. Visit the website to download the update.", "A newer version is available. Visit the website to download the update."),
        ("Desktop remote control client", "Desktop remote control client"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, HDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, HDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, HDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: HDesk server OSS doesn't include this feature."),
