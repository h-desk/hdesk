...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 HDesk 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 HDesk \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 HDesk \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 HDesk 使用\"无障碍\"服务。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 HDesk 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 HDesk 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 HDesk \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 HDesk \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 HDesk 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 HDesk 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 HDesk 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "请升级 HDesk 专业版服务器到{}或更高版本！"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，HDesk 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 HDesk 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 HDesk 后台服务"),
        ...
        ("About RustDesk", "关于 HDesk"),
        ("About HDesk", "关于 HDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 HDesk 客户端升级至版本 {} 或更新版本！"),
        ...
        ("Plugin", "插件"),
        ("Reload", "重新加载"),
        ("No plugins available.", "当前没有可用插件。"),
        ("Reset keyboard shortcuts permission", "重置键盘快捷键权限"),
        ("clear-shortcuts-inhibitor-permission-tip", "重置已记住的键盘快捷键权限。"),
        ("confirm-clear-shortcuts-inhibitor-permission-tip", "确认要重置已保存的键盘快捷键权限吗？"),
        ...
        ("Check for software update", "检查软件更新"),
        ("You are already using the latest version.", "当前已是最新版本。"),
        ("Check and get the latest stable version of HDesk.", "检查并获取 HDesk 的最新稳定版本。"),
        ("A newer version is available and can be downloaded and installed directly.", "已检测到新版本，可直接下载并安装。"),
        ("A newer version is available. Visit the website to download the update.", "已检测到新版本，可前往官网获取更新。"),
        ("Desktop remote control client", "桌面端远程控制客户端"),
        ("Auto update", "自动更新"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，HDesk 会验证服务器证书。\n启用此选项后，在验证失败时，HDesk 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使用 TCP。\n启用此选项后，HDesk 将不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：HDesk 开源服务器 (OSS server) 不包含此功能。"),
