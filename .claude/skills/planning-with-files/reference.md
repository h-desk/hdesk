...
> In this repo, the persistent planning files live under `Application/docs/plans/`; any bare planning filename below refers to that directory rather than repo root.
